...
class TaskSplitterTest extends TestCase {
  ...
  public function testNullIdentity() {
    ...
    $expected = [
      ['context' => 'c=null,d=null', 'items' => [$i1, $i2]],
    ];
  ...
  public function testSingleIdentity() {
    ...
    $expected = [
      ['context' => 'c=10,d=1', 'items' => [$i1, $i2, $i3]],
    ];
    $actual = TaskSplitter::split($input);
    $this->assertEquals($expected, $actual);
  }
  ...
  public function testAlternateIdentities() {
    ...
    $expected = [
      ['context' => 'c=10,d=1', 'items' => [$i1, $i2]],
      ['context' => 'c=20,d=1', 'items' => [$i3, $i4, $i5]],
      ['context' => 'c=10,d=1', 'items' => [$i6]],
      ['context' => 'c=30,d=2', 'items' => [$i7, $i8]],
    ];
    $actual = TaskSplitter::split($input);
    $this->assertEquals($expected, $actual);
  }
